export * from './fonts';
export type { Fallback as FallbackFont, InputFont as Font, InputLocale as Locale, InputLocales as Locales, ResourceHint, WebFont, WebFontLocale, WebFontsJson } from './types';
